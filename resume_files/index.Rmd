...
```{r}
intro_text <- "Objective: A fulltime position in data science on a highly collaborative, diverse, driven team. Seeking mentorship via senior data scientists and analyst."
